...
template<typename PROPERTY_TYPE>
class CPropertySimple2
	: public CPropertyBase<PROPERTY_TYPE>
{
	using base = CPropertyBase<PROPERTY_TYPE>;
	std::unique_ptr<PROPERTY_TYPE> m_def_value;
public:
	CPropertySimple2(const PROPERTY_TYPE* pVal, const wchar_ngp* xml_tag)
		: base(pVal, xml_tag)
	{
	}

	CPropertySimple2(const PROPERTY_TYPE* pVal, const wchar_ngp* xml_tag, PROPERTY_TYPE def_val)
		: base(pVal, xml_tag)
	{
